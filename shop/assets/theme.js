  ...
  var Popover = function () {
    ...
    _createClass(Popover, [{
      ...
      value: function _valueChanged(event) {
        console.log("Popover _valueChanged");
      ...
      value: function _clickOutside(event) {
        console.log("Popiver click outside");
      ...
      value: function _position() {
        ...
        fastdom.mutate(function () {
          ...
          console.log(_this4.element);
          _this4.element.setAttribute('style', 'top: ' + parseInt(topPosition - 19 ) + 'px; right: ' + parseInt(rightPosition) + 'px;');
        });
      }
  ...
  var CollectionSection = function () {
    ...
    _createClass(CollectionSection, [{
      ...
      value: function _reloadProducts() {
        ...
        console.log("this _reloadProducts");
        ...
        fetch(location.pathname + '?view=ajax&sort_by=' + this.currentSortBy, {
          ...
          response.text().then(function (content) {
            ...
            document.dispatchEvent(new CustomEvent('theme:loading:end'));
            console.log("ici encore");
            document.dispatchEvent(new CustomEvent('kercambre:sorted:end'));
